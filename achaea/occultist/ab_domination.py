...
domination_aliases = [
    ...
    ("^leechon$", "auto bloodleech on", lambda _: auto_ent("bloodleech", on=True)),
    ("^leechoff$", "auto bloodleech off", lambda _: auto_ent("bloodleech", on=False)),
    (
        "^nem(?: (.+))?$",
        "nemesis []/t",
        lambda matches: command_ent("nemesis", matches[0] or v.target),
    ),
    ("^nemon$", "auto nemesis on", lambda _: auto_ent("nemesis", on=True)),
    ("^nemoff$", "auto nemesis off", lambda _: auto_ent("nemesis", on=False)),
    (
        "^poss$",
