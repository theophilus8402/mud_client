...
(Cyrenian Academy of Combat): Prythe says, "HELP CLANS will give you more information on how to switch to speaking here!"
...
(Market): Darutan says, "Crimson Arsenal - Herbs, Venoms, Bombs, Forged Goods! Shop where the Shield shops. ESS from Cyrene's bank."
