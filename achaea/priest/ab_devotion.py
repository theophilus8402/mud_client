...
devotion_aliases = [
    ...
    (
        "^ccalm(?: (.+))?$",
        "perform chaoscalm []/t",
        lambda matches: eqbal(f"perform chaoscalm {matches[0] or '&tar'}"),
    ),
    (
        "^vis(?: (.+))?$",
        "perform visions []/t",
    ...
    (
        ...
        lambda matches: eqbal("perform rite of well-being"),
    ),
    (
        "^revit$",
        "perform rite of revitalisation",
        lambda matches: eqbal("perform rite of revitalisation"),
    ),
    (
        "^penit(?: (.+))?$",
        "perform penitence []/t",
